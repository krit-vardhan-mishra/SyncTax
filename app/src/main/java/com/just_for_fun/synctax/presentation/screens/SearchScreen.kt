...
import com.just_for_fun.synctax.presentation.components.app.EmptySearchState
import com.just_for_fun.synctax.presentation.components.card.OnlineResultCard
...
fun SearchScreen(
    ...
    // Combined key includes filter to react to filter changes too
    ...
    //         SnackbarUtils.ShowSnackbarComposable(snackbarHostState, message)
    //     }
    // }
    ...
    Scaffold(
        ...
        DynamicAlbumBackground(
            ...
            androidx.compose.material3.pulltorefresh.PullToRefreshBox(
                isRefreshing = uiState.isSearchingOnline,
                onRefresh = { 
                    if (searchQuery.isNotEmpty()) {
                        homeViewModel.searchOnline(searchQuery, selectedFilter, forceRefresh = true)
                    }
                },
                                            ...
                                            modifier = Modifier
                                                ...
                                                .combinedClickable(
                                                    ...
                                                    onLongClick = {
                                                        ...
                                                        SnackbarUtils.showGlobalSnackbar(message = "Search history item deleted")
                                                    }
                                                )
                                                            ...
                                                            homeViewModel.fetchAlbumDetails(
                                                                ...
                                                                onResult = { albumDetails ->
                                                                    if (albumDetails != null && albumDetails.songs.isNotEmpty()) {
                                                                        ...
                                                                        SnackbarUtils.showGlobalSnackbar(message = "Album has no songs available")
                                                                    }
                                                                },
                                                                onError = { error ->
                                                                    SnackbarUtils.showGlobalSnackbar(message = "Failed to load album: $error")
                                                                }
                                                            )
                                                        }
                                                    }
                                                            ...
                                                            homeViewModel.fetchArtistDetails(
                                                                ...
                                                                onResult = { artistDetails ->
                                                                    if (artistDetails != null && artistDetails.songs.isNotEmpty()) {
                                                                        ...
                                                                        SnackbarUtils.showGlobalSnackbar(message = "Artist has no songs available")
                                                                    }
                                                                },
                                                                onError = { error ->
                                                                    SnackbarUtils.showGlobalSnackbar(message = "Failed to load artist: $error")
                                                                }
                                                            )
                                                        }
                                                    }
                                                                ...
                                                                onResult = { albumDetails ->
                                                                    if (albumDetails != null && albumDetails.songs.isNotEmpty()) {
                                                                        ...
                                                                        onNavigateToAlbum(
                                                                         ...
                                                                         SnackbarUtils.showGlobalSnackbar(message = "Podcast support is experimental")
                                                                    }
                                                                },
                                                                onError = { 
                                                                     // Failed to load as album
                                                                     SnackbarUtils.showGlobalSnackbar(message = "Could not open podcast")
                                                                }
                                                            )
                                                         }
                                                    }
