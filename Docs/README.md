...
- FusionAgent.md — Explains how recommendations are fused together across agents.
- PythonModel.md — Details about the Python-based ML model (k-means + z-score scorer) used via Chaquopy.
- AppOverview.md — High-level description of app architecture and components.
