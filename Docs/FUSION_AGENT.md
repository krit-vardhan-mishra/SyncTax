...
|-------|---------|--------|
| StatisticalAgent | Feature-based scoring | Configurable |
| CollaborativeFilteringAgent | History-based similarity | Configurable |
| Python ML Model | K-means clustering | Configurable |
